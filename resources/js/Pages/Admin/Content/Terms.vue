...
<template>
  <AdmLayout title="Terms & Conditions">

    <Row :center="true" justify="start">
      <v-btn
          variant="outlined"
          @click.prevent="$inertia.visit(route('admin.legal_content'))">Close</v-btn>
      <v-btn @click.prevent="legalCategoryModal.openCategory('terms')">Create category</v-btn>
    </Row>
                        ...
                        <Col gap="2">
                          <Row :center="true" justify="between">
                            ...
                            <div>
                              <v-btn
                                  variant="outlined"
                                  @click.prevent="legalCategoryModal.openCategory('terms', category)"
                                    ...
                                    <Row :center="true" justify="between">
                                      <Col>
                                        <Row :center="true" justify="between">
                                          ...
                                          <v-btn
                                              @click.prevent="legalParagraphModal.openParagraph('terms', category, element)"
                          ...
                          <div>
                            <v-btn
                                @click.prevent="legalParagraphModal.openParagraph('terms', category)"
