...
import { _ as _sfc_main$8 } from "./CbbAj4_Z-3325417239741.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./Cyl_ukyB-3352317127354.js";
import { _ as _sfc_main$7 } from "./CbZ9NF89-7342344235113.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AdmLayout, mergeProps({ title: "Orders" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-row flex-wrap gap-3 mb-5" data-v-fda401e1${_scopeId}>`);
            _push2(ssrRenderComponent(_component_v_btn, {
            ...
            if (props.orders.data.length > 0) {
              _push2(`<div class="flex flex-col gap-7 md:gap-3 text-sm" data-v-fda401e1${_scopeId}><!--[-->`);
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(_sfc_main$7, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div class="flex flex-col justify-center bg-grey-lighten-3 p-2 col-span-2 lg:col-span-1" data-v-fda401e1${_scopeId4}><div data-v-fda401e1${_scopeId4}><strong data-v-fda401e1${_scopeId4}>${ssrInterpolate(order.initial)}${ssrInterpolate(order.number)} </strong><span class="text-blue" data-v-fda401e1${_scopeId4}>(${ssrInterpolate(order.type)})</span></div><p data-v-fda401e1${_scopeId4}><span data-v-fda401e1${_scopeId4}>${ssrInterpolate(order.full_name ?? "No name")}</span>`);
                                  if (order.user_id) {
                                    _push5(`<span data-v-fda401e1${_scopeId4}> (${ssrInterpolate(order.user.name)})</span>`);
                                  } else {
                                    _push5(`<span data-v-fda401e1${_scopeId4}> (guest)</span>`);
                                  }
                                  _push5(`</p><div class="flex flex-row flex-wrap items-center gap-0" data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>${ssrInterpolate(order.email ?? "no email")}</p>`);
                                  if (order.phone) {
                                  ...
                                  if (order.phone) {
                                    _push5(`<p data-v-fda401e1${_scopeId4}>${ssrInterpolate(order.phone)}</p>`);
                                  } else {
                                    _push5(`<!---->`);
                                  }
                                  _push5(`</div></div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Amount</p> $${ssrInterpolate(order.amount)}</div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_sfc_main$4, {
                                    center: true,
                                    justify: "start"
                                  }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<p class="font-bold" data-v-fda401e1${_scopeId5}>${ssrInterpolate(order.type === "catering" ? "Pickup" : "Delivery")}</p>`);
                                        if (order.notes) {
                                  ...
                                  _push5(` ${ssrInterpolate(order.datetime_formatted)}</div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Items</p><div data-v-fda401e1${_scopeId4}>`);
                                  ...
                                  _push5(`</div></div><div class="uppercase flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Status</p> ${ssrInterpolate(order.status)} `);
              ...
              _push2(`<!--]--><div data-v-fda401e1${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$8, {
                entities: props.orders
              }, null, _parent2, _scopeId));
              _push2(`</div></div>`);
            } else {
              _push2(`<div data-v-fda401e1${_scopeId}><p data-v-fda401e1${_scopeId}>There are no orders to show here at the moment.</p></div>`);
            }
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (selectedOrder.value) {
                    _push3(`<div class="flex flex-col gap-3" data-v-fda401e1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_v_card, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="mb-5" data-v-fda401e1${_scopeId3}><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId3}>Order summary</p>`);
                          _push4(ssrRenderComponent(_component_v_card, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div data-v-fda401e1${_scopeId4}>`);
                                _push5(ssrRenderComponent(_sfc_main$7, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="flex flex-col justify-center bg-grey-lighten-3 p-2 col-span-2 lg:col-span-1" data-v-fda401e1${_scopeId5}><div data-v-fda401e1${_scopeId5}><strong data-v-fda401e1${_scopeId5}>${ssrInterpolate(selectedOrder.value.initial)}${ssrInterpolate(selectedOrder.value.number)} </strong><span class="text-blue" data-v-fda401e1${_scopeId5}>(${ssrInterpolate(selectedOrder.value.type)})</span></div><p data-v-fda401e1${_scopeId5}><span data-v-fda401e1${_scopeId5}>${ssrInterpolate(selectedOrder.value.full_name ?? "No name")}</span>`);
                                      if (selectedOrder.value.user_id) {
                                        _push6(`<span data-v-fda401e1${_scopeId5}> (${ssrInterpolate(selectedOrder.value.user.name)})</span>`);
                                      } else {
                                        _push6(`<span data-v-fda401e1${_scopeId5}> (guest)</span>`);
                                      }
                                      _push6(`</p><div data-v-fda401e1${_scopeId5}><p data-v-fda401e1${_scopeId5}>${ssrInterpolate(selectedOrder.value.email ?? "no email")}</p>`);
                                      if (selectedOrder.value.phone) {
                                        _push6(`<p data-v-fda401e1${_scopeId5}>${ssrInterpolate(selectedOrder.value.phone)}</p>`);
                                      } else {
                                        _push6(`<!---->`);
                                      }
                                      _push6(`</div></div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId5}><p class="font-bold" data-v-fda401e1${_scopeId5}>Amount</p> $${ssrInterpolate(selectedOrder.value.amount)}</div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId5}><p class="font-bold" data-v-fda401e1${_scopeId5}>${ssrInterpolate(selectedOrder.value.type === "catering" ? "Pickup" : "Delivery")}</p> ${ssrInterpolate(selectedOrder.value.datetime_formatted)}</div><div class="flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId5}><p class="font-bold" data-v-fda401e1${_scopeId5}>Items</p><div data-v-fda401e1${_scopeId5}>`);
                                      ...
                                      _push6(`</div></div><div class="uppercase flex flex-col justify-center bg-grey-lighten-3 p-2" data-v-fda401e1${_scopeId5}><p class="font-bold" data-v-fda401e1${_scopeId5}>Status</p> ${ssrInterpolate(selectedOrder.value.status)} `);
                          ...
                          _push4(`</div><div class="mb-5" data-v-fda401e1${_scopeId3}><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId3}>Order notes</p>`);
                          _push4(ssrRenderComponent(_component_v_card, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="p-4" data-v-fda401e1${_scopeId4}>`);
                                if (editOrderNotes.value) {
                                  _push5(`<div class="mb-4" data-v-fda401e1${_scopeId4}>`);
                                  ...
                                  _push5(`<p data-v-fda401e1${_scopeId4}>${selectedOrder.value.notes_formatted ?? ""}</p>`);
                                } else {
                                  _push5(`<!---->`);
                                }
                                _push5(`<div class="mt-2" data-v-fda401e1${_scopeId4}>`);
                                _push5(ssrRenderComponent(_sfc_main$4, {
                                  center: true,
                                  justify: "start"
                                }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      if (editOrderNotes.value) {
                                        _push6(`<div data-v-fda401e1${_scopeId5}>`);
                                        _push6(ssrRenderComponent(_component_v_btn, {
                                          size: "small",
                          ...
                          _push4(`</div><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId3}>Order items</p><div data-v-fda401e1${_scopeId3}>`);
                          _push4(ssrRenderComponent(_sfc_main$3, { gap: "4" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<!--[-->`);
                                ssrRenderList(selectedOrder.value.items, (item) => {
                                  _push5(`<div class="bg-grey-lighten-2 p-3" data-v-fda401e1${_scopeId4}><div class="flex lg:flex-row items-center justify-start gap-3 w-full" data-v-fda401e1${_scopeId4}><div class="hidden lg:flex shrink-0 w-[70px]" data-v-fda401e1${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_component_v_img, {
                                    "aspect-ratio": "1",
                                    src: item.thumbnail,
                                    cover: ""
                                  }, null, _parent5, _scopeId4));
                                  _push5(`</div><div class="grow" data-v-fda401e1${_scopeId4}>`);
                                  _push5(ssrRenderComponent(_sfc_main$7, {
                                    cols: "1",
                                    md: "5",
                                    lg: "5",
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div class="uppercase font-bold" data-v-fda401e1${_scopeId5}>${ssrInterpolate(item.product_name)}</div><div class="uppercase" data-v-fda401e1${_scopeId5}>${ssrInterpolate(item.variation_name)}</div><div class="uppercase" data-v-fda401e1${_scopeId5}>$${ssrInterpolate(item.variation_price)}</div><div class="uppercase" data-v-fda401e1${_scopeId5}>${ssrInterpolate(item.quantity)}</div><div class="uppercase" data-v-fda401e1${_scopeId5}>$${ssrInterpolate(item.amount)}</div>`);
                                      } else {
                                        return [
                                  ...
                                  _push5(`</div></div>`);
                                  if (item.client_note) {
                                    _push5(`<div class="mt-2" data-v-fda401e1${_scopeId4}><p class="text-red" data-v-fda401e1${_scopeId4}>Client note</p>`);
                                    _push5(ssrRenderComponent(_component_v_textarea, {
                                      rows: "1",
                                      "auto-grow": "",
                    ...
                    _push3(ssrRenderComponent(_sfc_main$7, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="my-5 h-full bg-grey-lighten-2 px-3 py-2" data-v-fda401e1${_scopeId3}><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId3}>Order status</p>`);
                          _push4(ssrRenderComponent(_component_v_card, { color: "grey-lighten-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="p-1" data-v-fda401e1${_scopeId4}>`);
                          ...
                          _push4(`</div><div class="my-5 h-full bg-grey-lighten-2 px-3 py-2" data-v-fda401e1${_scopeId3}><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId3}>Payment</p><!--[-->`);
                          ssrRenderList(selectedOrder.value.payments, (payment) => {
                            _push4(ssrRenderComponent(_sfc_main$7, {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<div data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Amount</p><div data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>${ssrInterpolate(payment.amount_display)}</p></div></div><div data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Captured</p><div data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>${ssrInterpolate(payment.amount_captured_display)}</p></div></div><div data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Card</p><div data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>...${ssrInterpolate(payment.card_last_4)}</p></div></div><div data-v-fda401e1${_scopeId4}><p class="font-bold" data-v-fda401e1${_scopeId4}>Status</p><div data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>${ssrInterpolate(payment.status)}</p></div></div>`);
                                } else {
                                  return [
                                    createVNode("div", null, [
                                      createVNode("p", { class: "font-bold" }, "Amount"),
                    ...
                    _push3(`<div data-v-fda401e1${_scopeId2}><div class="my-5" data-v-fda401e1${_scopeId2}><p class="text-2xl font-bold mb-2" data-v-fda401e1${_scopeId2}>Refunds</p>`);
                              ...
                              if (_push5) {
                                if (selectedOrder.value.refunds.length > 0) {
                                  _push5(ssrRenderComponent(_component_v_table, { class: "bg-grey-lighten-2" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<thead data-v-fda401e1${_scopeId5}><tr data-v-fda401e1${_scopeId5}><th data-v-fda401e1${_scopeId5}>Amount</th><th data-v-fda401e1${_scopeId5}>Status</th></tr></thead><tbody data-v-fda401e1${_scopeId5}><!--[-->`);
                                        ssrRenderList(selectedOrder.value.refunds, (refund) => {
                                          _push6(`<tr data-v-fda401e1${_scopeId5}><td data-v-fda401e1${_scopeId5}><p data-v-fda401e1${_scopeId5}>${ssrInterpolate(refund.amount_display)}</p></td><td data-v-fda401e1${_scopeId5}><p data-v-fda401e1${_scopeId5}>${ssrInterpolate(refund.status)}</p></td></tr>`);
                                        });
                                        _push6(`<!--]--></tbody>`);
                                      } else {
                                        return [
                                  ...
                                  _push5(`<div data-v-fda401e1${_scopeId4}><p data-v-fda401e1${_scopeId4}>There are no refunds to show for this order</p></div>`);
                                }
                              } else {
                                return [
                    ...
                    if (showRefunds.value) {
                      _push3(`<div class="mt-5" data-v-fda401e1${_scopeId2}><div class="flex flex-col lg:flex-row items-center gap-2 w-full" data-v-fda401e1${_scopeId2}><div class="grow w-full" data-v-fda401e1${_scopeId2}><div class="grid grid-cols-1 lg:grid-cols-2 gap-3" data-v-fda401e1${_scopeId2}><div class="w-full" data-v-fda401e1${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_v_text_field, {
                      ...
                      _push3(`</div><div data-v-fda401e1${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_v_text_field, {
                      ...
                      _push3(`</div></div></div><div class="shrink-0" data-v-fda401e1${_scopeId2}>`);
                      ...
                      _push3(`</div></div><div class="flex flex-row items-center justify-center w-full" data-v-fda401e1${_scopeId2}><div data-v-fda401e1${_scopeId2}>`);
                    ...
                    if (Object.keys(local_errors.value).length) {
                      _push3(`<div class="flex flex-col justify-center" data-v-fda401e1${_scopeId2}><!--[-->`);
                      ssrRenderList(Object.values(local_errors.value), (error, index) => {
                        _push3(`<p class="text-red w-full text-center" data-v-fda401e1${_scopeId2}>${ssrInterpolate(error)}</p>`);
                      });
                      _push3(`<!--]--></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="flex flex-row justify-center items-center gap-2 w-full my-5" data-v-fda401e1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_v_btn, {
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fda401e1"]]);
export {
  Home as default
};
